...
export default function RegisterPage() {
  ...
  return (
    <section className="relative min-h-[100dvh] w-full flex items-center justify-center px-4 py-6 sm:py-8 bg-gradient-to-br from-[#F0FDF4] via-white to-[#F0FDF4] overflow-hidden">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3">
          {/* Username */}
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[#1F2937] mb-1 sm:mb-1.5 text-bangla-safe">
              {t('usernameLabel')}
            </label>
