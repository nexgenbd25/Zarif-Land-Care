    ...
    <section className="relative min-h-[100dvh] w-full flex items-center justify-center px-4 py-4 sm:py-8 bg-gradient-to-br from-[#F0FDF4] via-white to-[#F0FDF4] overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-5 sm:mb-7">
          ...
          >
            <Image
              ...
              width={200}
              height={60}
              className="h-12 sm:h-16 w-auto object-contain mx-auto transition-transform duration-300 group-hover:scale-105"
              unoptimized
            />
          </Link>
        </div>
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1F2937] text-bangla-heading pt-1 pb-2">
            {t('title')}
          </h1>
          <p className="text-sm sm:text-base text-[#6B7280] text-bangla-safe">
            {t('subtitle')}
          </p>
        </div>
