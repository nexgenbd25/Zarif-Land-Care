          ...
          <div className="px-6 pb-8 pt-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg font-bold text-[#1F7A3F] bg-[#F0FDF4] border-2 border-[#1F7A3F]/20 hover:bg-[#1F7A3F] hover:text-white hover:border-[#1F7A3F] transition-all duration-300 active:scale-[0.98]"
              >
