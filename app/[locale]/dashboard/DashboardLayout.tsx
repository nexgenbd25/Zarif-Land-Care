...
export default function DashboardLayout({
  ...
  // 🎯 Sidebar open hole body lock (mobile)
  useEffect(() => {
    if (isSidebarOpen) {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F8FAF9] flex">
      {/* ===== Desktop Sidebar — GPU ACCELERATED + FIXED ===== */}
      <aside
        className="hidden lg:flex lg:flex-col lg:w-72 bg-gradient-to-b from-[#0F3D1F] via-[#0A2E17] to-[#061B0D] text-white fixed inset-y-0 left-0 z-40 overflow-hidden"
        style={{
