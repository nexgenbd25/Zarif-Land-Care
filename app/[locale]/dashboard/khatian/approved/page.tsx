...
const APPROVED_KHATIANS: Khatian[] = [
  {
    id: 1,
    serialNo: '01',
    mouzaName: 'বড়াইল',
    ownerName: 'মোঃ আব্দুল কাদির',
  ...
  },
  {
    ...
    ownerName: 'মোঃ শাহাদাত হোসেন',
    khatianType: 'সরকারি খতিয়ান',
    khatianNo: '1103',
    dagNo: '2252',
    landAmount: '১.৭৫ একর',
    remarks: 'পরিবারিক খতিয়ান',
    pdfUrl: 'N/A',
    date: '2024-03-20',
  },
  {
...
export default function ApprovedKhatianPage() {
  ...
  const filteredKhatians = useMemo(() => {
    return APPROVED_KHATIANS.filter((k) => {
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-[10px] font-bold uppercase tracking-wider">
                      <CheckCircle2 size={10} />#{k.serialNo}
                    </span>
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-[10px] font-bold uppercase tracking-wider">
                      <CheckCircle2 size={10} />
                      {t('approvedStatus')}
