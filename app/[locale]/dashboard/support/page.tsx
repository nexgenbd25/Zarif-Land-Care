...
const TICKETS: SupportTicket[] = [
  {
    ...
    status: 'open',
    message:
      'আমি আমার অ্যাকাউন্টে লগইন করতে পারছি না। পাসওয়ার্ড দিলে বলছে ভুল।',
    attachments: [],
  ...
  },
  {
    id: 2,
    ticketNo: 'TKT-002',
    subject: 'দলিল পেমেন্ট ইস্যু',
    priority: 'medium',
    status: 'answered',
    message:
      'দলিল এর পেমেন্ট করেছি কিন্তু কনফার্মেশন পাই নাই।',
    attachments: ['payment-slip.jpg'],
    createdAt: '2026-09-16T14:20:00',
  },
  {
    id: 3,
    ticketNo: 'TKT-003',
    subject: 'PDF আপলোড সমস্যা',
    priority: 'low',
    status: 'open',
    message: 'দলিল PDF আপলোড করতে গিয়ে error দেখাচ্ছে।',
    attachments: [],
  ...
  },
  {
    id: 4,
    ticketNo: 'TKT-004',
    subject: 'প্রোফাইল আপডেট সমস্যা',
    priority: 'medium',
    status: 'closed',
    message: 'প্রোফাইলে নতুন তথ্য যোগ করতে সমস্যা হচ্ছে।',
    attachments: [],
  ...
  },
  {
    id: 5,
    ticketNo: 'TKT-005',
    subject: 'নতুন ফিচার রিকোয়েস্ট',
    priority: 'low',
    status: 'answered',
    message:
      'আমি চাই দলিল PDF ডাউনলোড করার অপশন থাকুক।',
    ...
    <DashboardLayout user={user} onLogout={handleLogout}>
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 sm:mb-5">
          ...
          <Link
            href={`/${isBn ? '' : locale + '/'}dashboard/support/new`}
                      ...
                      <div className="flex items-center gap-2 p-3 rounded-xl bg-[#F8FAF9] border border-[#E5E7EB]">
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs font-bold text-[#1F2937]">
                            {new Date(viewTicket.createdAt).toLocaleDateString(
                              isBn ? 'bn-BD' : 'en-US'
                            )}
                          </p>
                        </div>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <ul className="space-y-1">
                            {viewTicket.attachments.map((file, i) => (
                              <li
                                key={i}
                                className="text-xs text-[#1F2937] text-bangla-safe break-all"
                              >
                                📎 {file}
                              </li>
                            ))}
