...
export default function NewTicketPage() {
  ...
  const content = {
    ...
    noFile_bn: 'কোনো ফাইল নির্বাচন করা হয়নি',
    noFile_en: 'No file chosen',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        router.push(`/${isBn ? '' : locale + '/'}dashboard/support`);
      }, 1200);
    }, 1200);
  };
                ...
                <div className="w-full min-w-0">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full pl-3 pr-10 py-2.5 rounded-lg border transition-all duration-200 bg-white text-sm text-[#1F2937] text-bangla-safe focus:outline-none focus:ring-2 appearance-none cursor-pointer font-semibold ${
                        errors.priority
                          ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20'
                          : 'border-[#E5E7EB] focus:border-[#1F7A3F] focus:ring-[#1F7A3F]/20'
                      }`}
